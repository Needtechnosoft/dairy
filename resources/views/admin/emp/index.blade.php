                    ...
                    <form id="form_validation" method="POST" onsubmit="return saveData(event);">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <input type="number" id="phone" name="phone" class="form-control" placeholder="Enter employee phone" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <input type="text" id="address" name="address" class="form-control" placeholder="Enter employee address" required>
                                </div>
                            </div>
                    ...
                    <form id="editform" onsubmit="return editData(event);">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="name">Employee Name</label>
                                <div class="form-group">
                                    <input type="text" id="ename" name="name" class="form-control" placeholder="Enter Employee name" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <label for="name">Employee Phone</label>
                                <div class="form-group">
                                    <input type="number" id="ephone" name="phone" class="form-control" placeholder="Enter Employee phone" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <label for="name">Employee Address</label>
                                <div class="form-group">
                                    <input type="text" id="eaddress" name="address" value="" class="form-control" placeholder="Enter Employee address" required>
                                </div>
                            </div>
